...
//import com.ing.wbaa.gargoyle.sts.data.aws.{AwsAccessKey, AwsCredentialWithToken, AwsSecretKey, AwsSessionToken}
...
//
//    override protected[this] def assumeRoleWithWebIdentityResponseToXML(awsCredentialWithToken: AwsCredentialWithToken, userInfo: UserInfo, roleArn: String, roleSessionName: String): NodeSeq =
//      <assumeRoleWithWebIdentity></assumeRoleWithWebIdentity>
//
//    override def verifyToken(token: BearerToken): Option[UserInfo] =
//      token.value match {
//        case "valid" => Some(data.UserInfo("token", UserName("name"), Set.empty))
//        case _       => None
//      }
//
//    override protected[this] def getAwsCredentialWithToken(userInfo: UserInfo, durationSeconds: Option[Duration]): Future[Option[AwsCredentialWithToken]] =
//      Future.successful(Some(AwsCredentialWithToken(AwsAccessKey("accesskey"), AwsSecretKey("secretkey"), AwsSessionToken("token", Duration(1, TimeUnit.MINUTES)))))
//  }
//
