...
import com.ing.wbaa.airlock.sts.data.AuthenticationTokenId
import com.ing.wbaa.airlock.sts.data.aws.{ AwsCredentialWithToken, AwsRoleArn }
...
trait TokenXML extends ScalaXmlSupport {
   ...
   *
   * @param roleArn         - arn role e.g. arn:airlock:sts...
