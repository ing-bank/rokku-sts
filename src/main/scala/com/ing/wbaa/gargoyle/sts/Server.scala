...
import com.ing.wbaa.gargoyle.sts.service.db.dao.{ STSTokenDAO, STSUserDAO }

object Server extends App {
  new GargoyleStsService with KeycloakTokenVerifier with UserTokenDbService with TokenDb with STSUserDAO with STSTokenDAO with MariaDb {
