...
object Server extends App {
  new AirlockStsService with KeycloakTokenVerifier with UserTokenDbService with STSUserAndGroupDAO with STSTokenDAO
  with MariaDb with ExpiredTokenCleaner {
    implicit override lazy val system: ActorSystem = ActorSystem.create("rokku-sts")
